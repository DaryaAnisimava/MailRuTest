...
public class MailPage {
    ...
    public String sentMail(String to, String theme, String body) {
        driver.findElement(By.className("compose-button__wrapper")).click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[@class='button2__wrapper'][@tabindex='570']")));
        driver.findElement(By.xpath("//input[@class='container--H9L5q size_s_compressed--2c-eV'][@tabindex='100']")).sendKeys(to);
        driver.findElement(By.xpath("//input[@class='container--H9L5q size_s_compressed--2c-eV'][@tabindex='400']")).sendKeys(theme);
        ...
        driver.switchTo().defaultContent();
        driver.findElement(By.xpath("//span[@class='button2__wrapper'][@tabindex='570']")).click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div[9]/div/div/div[2]/div[2]/div/div/div[2]")));
        return driver.findElement(By.xpath("/html/body/div[9]/div/div/div[2]/div[2]/div/div/div[2]")).getText();
    ...
    public String removeMail() {
        driver.findElement(By.xpath("//*[@id='ph_mail']/span")).click();
        driver.findElement(By.xpath("//*[@class='ico ico_16-actions:reply_s ico_actions:reply_s ico_size_s']")).click();
        driver.findElement(By.xpath("//span[@class='ll-av__img']")).click();
        driver.findElement(By.xpath("//*[@class='ico ico_16-delete ico_size_s']")).click();
        return driver.findElement(By.xpath("//span[text()='В папке нет писем.']")).getText();

    }

    public String cleanBasket() {
        driver.findElement(By.xpath("//*[@href='/trash/']")).click();
        WebElement element=driver.findElement(By.xpath("//*[@href='/trash/']"));
        rightClick(element);
        driver.findElement(By.xpath("/html/body/div[12]/div/div/div/div/div[4]/span[2]")).click();
        driver.findElement(By.xpath("//span[text()='Очистить']")).click();
        return driver.findElement(By.xpath("//*[text()='В корзине пусто']")).getText();
    }
